...
import { create } from '../../stores/subdomains/subdomainsSlice';
...
SubdomainsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_SUBDOMAINS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default SubdomainsNew;
