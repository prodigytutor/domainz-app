...
import { create } from '../../stores/apis/apisSlice';
...
ApisNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_APIS'}>{page}</LayoutAuthenticated>
  );
};
