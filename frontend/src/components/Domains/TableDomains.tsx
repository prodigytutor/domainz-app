...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/domains/domainsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureDomainsCols';
...
const TableSampleDomains = ({
  ...
  useEffect(() => {
    if (domainsNotify.showNotification) {
      notify(domainsNotify.typeNotification, domainsNotify.textNotification);
    }
  }, [domainsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/domains/domains-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {domains && Array.isArray(domains) && !showGrid && (
        <ListDomains
          domains={domains}
          loading={loading}
...
export default TableSampleDomains;
