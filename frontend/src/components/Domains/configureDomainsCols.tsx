...
export const loadColumns = async (
  ...
  const hasUpdatePermission = hasPermission(user, 'UPDATE_DOMAINS');
  ...
  return [
...

    {
      ...
      valueGetter: (params: GridValueGetterParams) =>
        new Date(params.row.registration_date),
    },

    {
      field: 'renewal_date',
      headerName: 'RenewalDate',
      flex: 1,
      minWidth: 120,
      filterable: false,
      headerClassName: 'datagrid--header',
      ...
      type: 'dateTime',
      valueGetter: (params: GridValueGetterParams) =>
        new Date(params.row.renewal_date),
    },
