...
const ListHostings = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_HOSTINGS');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.provider}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.account_credentials}</p>
                  </div>
